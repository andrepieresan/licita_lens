...
export type { Deal, DealFollowUp, DealStage, NotificationPreferencesPayload, SessionPayload } from "./types";
...
export interface LicitaLensAPI {
  ...
  signup(input: { email: string; password: string; full_name: string; organization_name: string; plan: "essential" | "pro" }): Promise<SessionPayload>;
